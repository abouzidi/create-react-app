...
module.exports = {
  ...
  entry: [require.resolve('./polyfills'), require.resolve('./app.index.js')],
  output: {
    // The build folder.
    path: paths.appBuild,
                  ...
                  use: [
                    ...
                    },
                    {
                      ...
                      options: {
                        ...
                        ident: 'postcss',
                        plugins: () =>
                          [].concat(localConfig.postcssPlugins, [
                            autoprefixer({
                              browsers: [
                                '>1%',
                                'last 4 versions',
  ...
  ].concat(localConfig.webpack.plugins),
